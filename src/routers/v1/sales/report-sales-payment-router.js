        ...
        manager.readAll(query)
            .then(docs => {
                ...
                for (var salesPerDay of docs.data) {
                    ...
                    totalOmsetNetto = parseInt(salesPerDay.grandTotal);
                    ...
                    result["Total Omset Bruto"] = parseInt(totalOmsetBruto);
                    result["Total Diskon Penjualan"] = parseInt(totalDiskonPenjual);
                    result["Total Margin"] = parseInt(totalMargin);
                    result["Total Omset Netto"] = parseInt(totalOmsetNetto);
